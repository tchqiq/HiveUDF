...
public class SortedCollectSet extends AbstractGenericUDAFResolver
{
    @Override
    ...
    public static class CollectAllEvaluator extends GenericUDAFEvaluator
    {
        ...
        {
            ArrayAggregationBuffer agg = (ArrayAggregationBuffer) ab;
            ArrayList<Object> ret = new ArrayList<Object>(agg.container);
            Collections.sort(ret, new Comparator() {

                @Override
                public int compare(Object o1, Object o2) {
                  return ObjectInspectorUtils.compare(o1, inputOI, o2, inputOI);
                }
              });
            return ret;
        }
